...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_konstruktori_asettaaa_saldon_oikein(self):
        self.kortti = Maksukortti(1000)
    ...
    def test_kortilla_pystyy_ostamaan_edullisen_kun_raha_riittaa(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")

    def test_kortilla_pystyy_ostamaan_maukkaan_kun_raha_riittaa(self):
